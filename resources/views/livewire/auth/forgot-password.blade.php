...
<head>
    ...
    <title>Forgot Password – Laravel Zip Api Client</title>
    ...
    <div class="container-sm py-5">
        <div class="mx-auto" style="max-width: 460px;">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="d-grid mt-2">
                            <button type="submit" class="btn btn-primary py-2" data-test="email-password-reset-link-button">
            ...
            <div class="text-center mt-3 small text-body-secondary">
                ...
                <a href="{{ route('login') }}" class="link-primary ms-1">{{ __('log in') }}</a>
            </div>
        </div>
    </div>
</main>
